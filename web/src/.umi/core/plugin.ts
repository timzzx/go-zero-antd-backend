...
import * as Plugin_0 from '/home/code/go-zero-antd-backend/web/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/home/code/go-zero-antd-backend/web/src/app.tsx',
    },
    {
      apply: Plugin_1,
      path: process.env.NODE_ENV === 'production' ? void 0 : '/home/code/go-zero-antd-backend/web/src/.umi/plugin-access/runtime.tsx',
    },
    {
      apply: Plugin_2,
      path: process.env.NODE_ENV === 'production' ? void 0 : '/home/code/go-zero-antd-backend/web/src/.umi/plugin-initialState/runtime.tsx',
    },
    {
      apply: Plugin_3,
      path: process.env.NODE_ENV === 'production' ? void 0 : '/home/code/go-zero-antd-backend/web/src/.umi/plugin-layout/runtime.tsx',
    },
    {
      apply: Plugin_4,
